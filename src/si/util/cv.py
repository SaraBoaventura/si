...
class CrossValidation:
    ...
    def toDataframe(self):
        import pandas as pd 
        assert self.train_scores and self.test_scores, 'need to run model' # "tem de correr a função run primeiro"
...
class GridSearchCV():
    ...
    def run(self):
        ...
        for conf in itertools.product(*values):
            ...
            scores = CrossValidation(self.model, self.dataset, **self.kwargs).run()
